...
export const styles = StyleSheet.create({
  ...
  contentContainer: {
    alignItems: 'center', // ou qualquer outro estilo de layout necessário
    paddingBottom: 20, // opcional, caso queira um espaçamento inferior
    backgroundColor: theme.colors.white,
  },
...
tagText: {
  color: '#000',
  width: '100%', // Centralizar texto horizontalmente
  flex: 1,
