...
export function ProfileScreen() {
  const [profileData, setProfileData] = React.useState<ProfileData | null>(null); // Estado para armazenar os dados do perfil
  ...
  //TODO:PARA TODAS AS TELAS DE EDIÇÃO REALIZAR VALIDAÇÃO DOS CAMPOS PARA TRATAR OS DADOS E EVITAR PROBLEMAS, COMO DATA DE TERMINO SER MENOR QUE INICIO E ETC
  ...
  const handleSettingsPress = () => {
    //TODO:TRATAR EXCLUSÃO DE USUÁRIO
      ...
      <View style={styles.content}>
        ...
        <View style={styles.preferencesContainer}>
          <View style={styles.header}>
            ...
            <TouchableOpacity onPress={handleEditCandidatePress} style={styles.editButton}>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.positionItem}>
            <FontAwesome5 name="id-card" size={20} color="black" style={styles.imageLogo} />
            <Text style={styles.text}>{profileData.CPF}</Text>
          </View>
          {/* Data de nascimento */}
          <View style={styles.positionItem}>
            <Ionicons name="calendar-outline" size={20} color="black" style={styles.imageLogo} />
            <Text style={styles.text}> {formatDate(profileData.birth_date)}</Text>
          </View>

          {/* Sexo */}
          <View style={styles.positionItem}>
            <Ionicons name="person-outline" size={20} color="black" style={styles.imageLogo} />
            <Text style={styles.text}>{profileData.sex}</Text>
          </View>

          {/* PCD */}
          <View style={styles.positionItem}>
            <MaterialIcons name="accessible" size={20} color="black" style={styles.imageLogo} />
            <Text style={styles.text}>{profileData.pcd ? "Sim" : "Não"}</Text>
          </View>

          {/* Email */}
          <View style={styles.positionItem}>
            <MaterialIcons name="email" size={20} color="black" style={styles.imageLogo} />
          ...
          {/* Endereço */}
          <View style={styles.positionItem}>
            <Ionicons name="location-outline" size={20} color="black" style={styles.imageLogo} />
        ...
        <View style={styles.preferencesContainer}>
          ...
          <TouchableOpacity onPress={handleEditPreferencesPress} style={styles.editButton}>
            <Feather name="edit-3" size={20} color="black" />
          </TouchableOpacity>
        </View>
        ...
        <View style={styles.pereferencessection}>
          <View style={styles.studyItem}>
            <Text style={styles.studyText}>{profileData.distance_radius} km</Text>
          </View>
        </View>
        ...
        <View style={styles.preferencesContainer}>
          ...
          <TouchableOpacity onPress={handleEditStudiesPress} style={styles.editButton}>
            <Feather name="edit-3" size={20} color="black" />
          </TouchableOpacity>
        </View>
        <View style={styles.section}>
            ...
            {profileData.candidateStudies.map(study => (
              <View key={study.candidate_study_id} style={styles.studyItem}>
                ...
                <Text style={styles.dateText}>
                  {formatDate(study.start_date)} - {formatDate(study.completion_date)}
                </Text>
              </View>
            ))}
          </View>
        ...
        <View style={styles.preferencesContainer}>
          ...
          <TouchableOpacity onPress={handleEditExperiencesPress} style={styles.editButton}>
            <Feather name="edit-3" size={20} color="black" />
          </TouchableOpacity>
        </View>
        <View style={styles.section}>
        ...
        <View style={styles.preferencesContainer}>
          ...
          <TouchableOpacity onPress={handleEditSkillsPress} style={styles.editButton}>
            <Feather name="edit-3" size={20} color="black" />
          </TouchableOpacity>
        </View>
        <View style={styles.section}>
        ...
        <View style={styles.preferencesContainer}>
          ...
          <TouchableOpacity onPress={handleEditLanguagesPress} style={styles.editButton}>
            <Feather name="edit-3" size={20} color="black" />
          </TouchableOpacity>
        </View>
        <View style={styles.studyList}>
          {profileData.candidateLanguages.map(lang => (
            <View key={lang.candidate_language_id} style={styles.studyItem}>
              <Text style={styles.studyText}>{lang.Language.course_name}: {lang.level}</Text>
            </View>
          ))}
        </View>
