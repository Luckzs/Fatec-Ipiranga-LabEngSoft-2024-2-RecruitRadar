...
import { ListAppliedVacancyController } from '../controllers/Vacancy/ListAppliedVacancyController';
import { ListVacancyWithoutMatchController } from '../controllers/Vacancy/ListVacancyWithoutMatchController';
import { PopulateVacancyController } from '../database/pyscripts/populatevacancy';
import { JobRecommendationController } from '../database/pyscripts/jobRecommendation';
import { ListProfessionalAreasFromVacanciesController } from '../controllers/Vacancy/ListProfessionalAreasFromVacanciesController';
...
const jobRecommendationController = new JobRecommendationController();
...
const populateVacancyController = new PopulateVacancyController(); 
const listProfessionalAreasFromVacanciesController =  new ListProfessionalAreasFromVacanciesController();
...
const listAppliedVacancyController = new ListAppliedVacancyController();
const listVacancyWithoutMatchController = new ListVacancyWithoutMatchController();
...
router.post("/populate_vacancies", populateVacancyController.handle);
router.post("/jobRecommendation", jobRecommendationController.handle);
router.get("/professional_areas", listProfessionalAreasFromVacanciesController.handle);
...
router.get("/application/:email", listAppliedVacancyController.handle);
router.get("/vacancynotmatch", listVacancyWithoutMatchController.handle);
