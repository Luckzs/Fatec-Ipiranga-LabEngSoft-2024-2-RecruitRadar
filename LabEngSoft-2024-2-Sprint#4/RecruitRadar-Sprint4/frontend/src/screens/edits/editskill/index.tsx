            ...
            {selectedSkill ? (
              ...
              <View style={styles.editContainer}>
                ...
                <View style={styles.buttonContainer}>
                  <TouchableOpacity style={styles.resetButton} onPress={() => setSelectedSkill(null)}>
                    <Text style={styles.buttonText}>Cancelar</Text>
                  </TouchableOpacity>
                  <TouchableOpacity style={styles.saveButton} onPress={handleUpdateSkill}>
              ...
              skills.length > 0 && (
                <TouchableOpacity style={styles.refreshButton} onPress={handleSubmit}>
                  <Text style={styles.buttonText}>Salvar Competências</Text>
                </TouchableOpacity>
              )
            )}
          </>
